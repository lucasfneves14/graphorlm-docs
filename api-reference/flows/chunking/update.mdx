...
description: 'Modify chunking node configurations in flows via the GraphorLM REST API'
---
...
<AccordionGroup>
  ...
  <Accordion icon="search" title="Chunking Node Not Found">
    **Solution**: Verify the node ID and flow:
    - Use the [List Chunking Nodes endpoint](/api-reference/flows/chunking/list) to get valid node IDs
