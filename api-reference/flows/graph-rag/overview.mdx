...
|----------|---------|---------|---------------|
| **List Graph RAG Nodes** | `GET` | Retrieve all graph RAG nodes from a flow | [📄 List Documentation](/api-reference/flows/graph-rag/list) |
| **Update Graph RAG Configuration** | `PATCH` | Modify graph RAG node settings | [🔧 Update Documentation](/api-reference/flows/graph-rag/update) |
