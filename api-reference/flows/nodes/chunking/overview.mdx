...
1. **List Current Nodes**: Use the [List Chunking Nodes](/api-reference/flows/nodes/chunking/list) endpoint to see existing configurations
2. **Update Parameters**: Use the [Update Chunking Configuration](/api-reference/flows/nodes/chunking/update) endpoint to modify settings
...
### Dataset Management
- Use [Dataset endpoints](/api-reference/flows/nodes/datasets/overview) to configure input sources
