...
description: 'Retrieve simulation results from flow nodes via the Graphor REST API'
---

Retrieve simulation results from specific nodes within your Graphor flows. This endpoint provides access to the output data generated during node simulation (not from deployed flow execution) with pagination support.
