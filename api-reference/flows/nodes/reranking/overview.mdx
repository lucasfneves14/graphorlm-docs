...
|----------|--------|---------|---------------|
| **[List Reranking Nodes](/api-reference/flows/reranking/list)** | `GET` | Retrieve reranking node configurations and status | Monitoring, analysis, configuration review |
| **[Update Reranking Configuration](/api-reference/flows/reranking/update)** | `PATCH` | Modify reranking parameters and settings | Optimization, tuning, strategy adjustment |
...
<CardGroup cols={2}>
  <Card
    ...
    icon="list"
    href="/api-reference/flows/reranking/list"
  >
  ...
  <Card
    ...
    icon="sliders"
    href="/api-reference/flows/reranking/update"
  >
