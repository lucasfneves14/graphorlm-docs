...
description: 'Modify reranking node configurations in flows via the Graphor REST API'
---

Update the configuration of a specific reranking node within a flow in your Graphor project. This endpoint allows you to optimize the LLM-powered document reranking process by adjusting the number of top results returned, directly impacting the quality and performance of your RAG (Retrieval-Augmented Generation) system.
