...
<CardGroup cols={2}>
  <Card
    ...
    icon="list"
    href="/api-reference/flows/retrieval/list"
  >
...
1. **List Current Nodes**: Use the [List Retrieval Nodes](/api-reference/flows/retrieval/list) endpoint to review existing configurations
2. **Analyze Performance**: Review metrics and identify optimization opportunities
3. **Update Configuration**: Use the [Update Retrieval Configuration](/api-reference/flows/retrieval/update) endpoint to apply optimizations
