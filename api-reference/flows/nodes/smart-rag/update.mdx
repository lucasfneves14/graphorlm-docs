...
description: 'Update smart RAG node configurations via the Graphor REST API'
---

Update the configuration of a smart RAG node within a specific flow in your Graphor project. Smart RAG nodes combine intelligent document processing, chunking, and retrieval operations, and their primary configuration parameter controls the number of top results to retrieve during query processing.
