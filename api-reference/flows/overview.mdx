...
description: 'Comprehensive guide to managing flows and datasets via the Graphor REST API'
---

The Flows API provides complete control over your RAG pipelines in Graphor. From deploying flows to managing comprehensive node configurations (datasets, chunking, retrieval, reranking, advanced RAG, and LLM nodes), these endpoints enable you to build, deploy, and execute sophisticated intelligent document processing workflows programmatically.
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    href="/api-reference/flows/nodes/retrieval/overview"
  >
  ...
  <Card
    ...
    href="/api-reference/flows/nodes/reranking/overview"
  >
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    href="/api-reference/flows/nodes/graph-rag/overview"
  >
