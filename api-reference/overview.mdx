...
### **RAG Pipelines API** - Pipeline Management  
Control RAG pipeline deployment, simulation and execution.
...
### **RAG Pipeline Nodes API** - Pipeline Nodes Management  
Comprehensive pipeline nodes configuration (datasets, chunking, retrieval, reranking, advanced RAG, and LLM nodes).
