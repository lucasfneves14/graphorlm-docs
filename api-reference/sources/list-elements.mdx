...
|-----------|------|----------|-------------|
| `file_id` | string | No* | Unique identifier for the source (preferred) |
| `file_name` | string | No* | Name of the source file to retrieve elements from (deprecated, use `file_id`) |
