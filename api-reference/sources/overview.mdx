...
<AccordionGroup>
  ...
  <Accordion icon="sparkles" title="Hi-Res (fine-tuned) Method">
    **Speed**: ⚡ **Accuracy**: ⭐⭐⭐⭐⭐
  ...
  <Accordion icon="project-diagram" title="GraphorLM (Beta) Method">
    **Speed**: ⚡ **Accuracy**: ⭐⭐⭐⭐
...
3. Upgrade to Hi-Res or Hi-Res (fine-tuned) if needed
