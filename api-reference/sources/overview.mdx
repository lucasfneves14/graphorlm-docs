...
<AccordionGroup>
  ...
  <Accordion icon="project-diagram" title="GraphorLM Method">
    **Speed**: ⚡ **Accuracy**: ⭐⭐⭐⭐
...
| Complex Documents | Hi-Res or Hi-Res FT | Better structure recognition; consider GraphorLM for semantic relationships |
...
<AccordionGroup>
  ...
  <Accordion icon="gears" title="Processing Strategy">
    **Method Selection**:
    ...
    - Use GraphorLM for enhanced semantic relationships and graph-based organization
