...
description: 'Upload sources (files, web pages, GitHub) to your project via the Graphor REST API'
---

This page documents Graphor's **source ingestion** endpoints. Use it to upload content to your project via the REST API — whether that content is a **local file**, a **public web page URL**, or a **public GitHub repository**.
