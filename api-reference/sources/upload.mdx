...
| `method` | string \| null | Strategy used (e.g. `fast`, `balanced`, `accurate`, `agentic`) |
...
| `method` | string | Processing method: `fast`, `balanced`, `accurate`, or `agentic` (see [Partition methods](#partition-methods)) | No |
