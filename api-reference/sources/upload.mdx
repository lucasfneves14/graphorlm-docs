...
<Note>
  You can reprocess documents with different methods using the [Process Source](/api/sources/process) endpoint after upload.
</Note>
...
<AccordionGroup>
  ...
  <Accordion icon="file-xmark" title="File processing failures">
    ...
    **Solutions**:
    ...
    - Use the [Process Source](/api/sources/process) endpoint with different methods
  </Accordion>
