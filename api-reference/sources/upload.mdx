...
| `partition_method` | string | Processing method to use (see [Partition Methods](#partition-methods) below) | No |
...
<Note>
For more details about processing methods, see the [Process Source](/api-reference/sources/process) documentation.
</Note>
...
| `partition_method` | string | Processing method to use (see [Partition Methods](#partition-methods) above) | No |
