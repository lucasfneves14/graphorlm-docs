...
# Document Chunking in GraphorLM
...
Choose which document element types to exclude from chunking:

- **None**: Include all document elements (default)
- **Headers/Footers**: Remove repetitive page headers and footers
- **Page numbers**: Remove page numbering
- **Custom selection**: Select specific element types to exclude

Excluding certain elements can improve retrieval quality by removing noise and repetitive content.
...
- For Smart Chunking: Set Chunk Size
- For By Character: Set Chunk Size, Overlap, and optional Separator
- For By Tokens: Set Chunk Size and Overlap

<img
  className="block border rounded-2xl border-gray-950\/10 ring-2 ring-transparent"
  src="/images/chunking-settings.png"
  alt="Chunking settings"
/>
...
- [Retrieval Guide](/guides/retrieval): Configure search parameters and algorithms
- [Evaluation Guide](/guides/evaluation): Measure and improve your RAG pipeline performance
- [LLM Integration](/guides/llm-integration): Connect language models to utilize your chunked content
