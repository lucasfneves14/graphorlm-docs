...
<AccordionGroup>
  <Accordion icon="file-excel" title="Poor OCR quality">
    ...
    - Using OCR Only, YOLOX, Advanced, or GraphorLM methods instead of Basic
  ...
  <Accordion icon="table" title="Table extraction problems">
    ...
    - Use YOLOX, Advanced, or GraphorLM method for better table detection
  ...
  <Accordion icon="language" title="Multi-language document issues">
    ...
    - Use YOLOX, Advanced, or GraphorLM method which has better multi-language support
  </Accordion>
...
<CardGroup cols={2}>
  ...
  <Card
    title="Smart RAG"
    icon="brain"
    href="/api-reference/flows/smart-rag"
  >
  ...
  <Card
    ...
    href="/api-reference/flows/graph-rag"
  >
