...
Graphor offers five parsing and classification methods to optimize document processing based on your needs:
...
1. Upload your document to Graphor
...
- **Graphor**: Experiment with for complex document relationships and advanced semantic understanding
...
<AccordionGroup>
  <Accordion icon="file-excel" title="Poor OCR quality">
    ...
    - Using OCR, Hi-Res, Hi-Res (tuned), or Graphor methods instead of Basic
  ...
  <Accordion icon="language" title="Multi-language document issues">
    ...
    - Use Hi-Res, Hi-Res (tuned), or Graphor method which has better multi-language support
...
- **Different content focus**: Use Graphor method for enhanced semantic relationships
