...
<CardGroup cols={2}>
  ...
  >
    Learn how to split documents into optimal chunks for retrieval
  </Card>
  <Card
    title="Retrieval"
  ...
  >
    Configure search parameters and algorithms for your RAG
  </Card>
  <Card
  ...
  >
    Improve your source documents with advanced parsing methods
  </Card>
  <Card
    title="Evaluation"
