...
The quality of chat responses depends on how well your documents were parsed:

- **Complex documents** — Use **MAI** or **Graphor** parsing for better understanding
- **Scanned documents** — Use **Hi-Res** or **Hi-Res FT** for accurate OCR
- **Simple text** — **Fast** parsing is usually sufficient

If you're getting poor answers, try reprocessing the document with a more advanced parsing method.
