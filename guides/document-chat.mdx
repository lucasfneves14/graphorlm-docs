...
To start a new conversation without previous context, click the **New conversation** button or refresh the chat interface.
...
| `file_name` | string (optional) | Restrict search to a specific document |
...
<CardGroup cols={2}>
  ...
  >
    Learn about parsing methods to improve chat quality
  </Card>
  <Card
    title="API Reference"
    icon="code"
  ...
  >
    Create advanced retrieval workflows with the Flow Builder
  </Card>
</CardGroup>
