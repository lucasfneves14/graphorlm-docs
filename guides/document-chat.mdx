...
<Note>
Document Chat uses the **active parsing version** of each document. The quality of answers directly depends on how well your documents were parsed. For better results, adjust the parsing settings and use advanced methods like **Accurate** or **Agentic** for complex documents. See [Data Ingestion](/guides/data-ingestion#document-parsing-methods) for details.
</Note>
...
| Complex layouts | Accurate or Agentic |
