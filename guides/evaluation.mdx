...
2. Connect it to the output of the component you want to evaluate
...
<img
  className="block border rounded-2xl border-gray-950\/10 ring-2 ring-transparent"
  src="/images/evaluation-results.png"
...
2. Focus on Precision@K and Recall@K metrics
...
<img
  className="block border rounded-2xl border-gray-950\/10 ring-2 ring-transparent"
  src="/images/comparative-evaluation.png"
...
<AccordionGroup>
  ...
  <Accordion icon="comment-slash" title="Poor response metrics (if using LLM)">
    **Solutions**:
    - Check if the retrieval is returning relevant chunks first
    ...
    - Adjust temperature settings to balance creativity and factual accuracy
  </Accordion>
...
3. **Use multiple metrics**: Different metrics provide different insights
