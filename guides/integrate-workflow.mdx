...
<img
  className="block border rounded-2xl border-gray-950\/10 ring-2 ring-transparent"
  src="/images/rest-api-integration.png"
...
```
https://api.graphorlm.com/v1/projects/{project_id}/flows/{flow_id}/query
```
...
```javascript
// POST request to https://api.graphorlm.com/v1/projects/{project_id}/flows/{flow_id}/query
// Headers must include a Bearer token for authentication

fetch("https://api.graphorlm.com/v1/projects/{project_id}/flows/{flow_id}/query", {
  method: "POST",
  headers: {
...
<img
  className="block border rounded-2xl border-gray-950\/10 ring-2 ring-transparent"
  src="/images/mcp-integration.png"
  ...
  "mcpServers": {
    "your-flow-name": {
      ...
      "args": [
        "--refresh",
        "mcp-proxy",
        "https://api.graphorlm.com/v1/projects/{project_id}/flows/{flow_id}/mcp/sse"
      ],
      "env": {
...
3. Replace `your-flow-name` with a unique name for your flow and `YOUR_API_TOKEN` with your API token.
...
6. Replace `your-flow-name` with a unique name for your flow and `YOUR_API_TOKEN` with your API token.

<img
  className="block border rounded-2xl border-gray-950\/10 ring-2 ring-transparent"
  src="/images/cursor-integration.png"
