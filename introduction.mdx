...
<CardGroup cols={3}>
  <Card title="Documents" icon="file-word">
    PDF, DOC, DOCX, ODT, PPT, PPTX, HTML, TXT
  </Card>
  <Card title="Tabular Data" icon="table">
    CSV, TSV, XLS, XLSX
  </Card>
  <Card title="Media Files" icon="photo-film">
    Images (PNG, JPG, TIFF, BMP, HEIC), Videos (MP4, MOV, AVI, MKV, WebM), Audio (MP3, WAV, M4A, OGG, FLAC)
  </Card>
</CardGroup>
