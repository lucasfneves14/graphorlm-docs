...
|--------------|---------|---------------|
| Encryption at rest | Cloud-provider-managed AES-256 by default; customer-managed encryption keys available on enterprise request | [Trust Center Overview §3](/trust/overview#3-encryption-posture) |
