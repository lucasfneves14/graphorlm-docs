...
- **Marketing-site analytics** — Google Analytics 4 (consent-gated, marketing site only; governed by the Google Measurement Controller-Controller Data Protection Terms — see [§10](#10-international-transfer-of-personal-data)).
...
- **Account deletion** by emailing [privacy@graphorlm.com](mailto:privacy@graphorlm.com) — Synapse processes account-level deletion within **15 calendar days** of request, applying the LGPD art. 19, II confirmation/access timeline by analogy as best practice. See [Data Retention §1](/trust/data-retention#1-retention-by-data-category).
...
| **Objection** (LGPD art. 18, § 2º / GDPR art. 21) | Under LGPD art. 18, § 2º, object to processing carried out under a consent-dispensation legal basis where there has been non-compliance with the LGPD; under GDPR art. 21, object to processing based on legitimate interests or for direct marketing (no LGPD direct equivalent). | Email [privacy@graphorlm.com](mailto:privacy@graphorlm.com). |
