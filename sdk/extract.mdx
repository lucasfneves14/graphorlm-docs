...
description: 'Extract structured data from documents using JSON Schema with the Graphor Python SDK'
---
...
|-----------|------|-------------|----------|
| `file_names` | `list[str]` | List of file names to extract data from | ✅ Yes |
...
| `thinking_level` | `str` | Controls model and thinking configuration: `"fast"`, `"balanced"` (default), `"accurate"` | No |
