---
title: 'List Sources'
description: 'List all sources in your project using the Graphor SDK'
---
...
| `partition_method` | `str \| null` | Partition method: `fast`, `balanced`, `accurate`, `vlm`, or `agentic` (when available) |
