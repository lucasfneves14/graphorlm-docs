...
<Tabs>
  <Tab title="Python">
    ...
    | `method` | `str \| None` | One of: `fast`, `balanced`, `accurate`, `agentic` (see [Partition methods](#partition-methods) below) | No |
  ...
  <Tab title="TypeScript">
    ...
    | `method` | `string \| null` | One of: `fast`, `balanced`, `accurate`, `agentic` (see [Partition methods](#partition-methods) below) | No |
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title="Python">
    ...
    | `method` | `str \| None` | One of: `fast`, `balanced`, `accurate`, `agentic` | No |
  ...
  <Tab title="TypeScript">
    ...
    | `method` | `string \| null` | One of: `fast`, `balanced`, `accurate`, `agentic` | No |
  </Tab>
</Tabs>
