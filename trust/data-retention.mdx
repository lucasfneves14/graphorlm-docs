...
Account-level deletion (delete the user account and every project owned by it) is handled out-of-band via [privacy@graphorlm.com](mailto:privacy@graphorlm.com) until the in-app self-service flow ships. Synapse processes account-level deletion within **15 calendar days** of request to satisfy LGPD art. 19.
