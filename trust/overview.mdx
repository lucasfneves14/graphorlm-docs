...
| **Compliance posture** | Synapse does not yet hold its own SOC 2 Type II or ISO 27001 certifications — honest, no aspirational dates. Inherited certifications from subprocessors are summarized in [Compliance §2](/trust/compliance#2-inherited-certifications). | [Compliance](/trust/compliance) |
