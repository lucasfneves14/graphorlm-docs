...
Material changes to an existing subprocessor's posture (loss of certification, change of region, change of training/retention defaults) trigger the same disclosure and customer-objection path as a new addition — see [DPA §4.3](/legal/dpa-template#43-customer-objection-to-a-subprocessor-change).
